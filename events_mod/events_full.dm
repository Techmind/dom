...
#req_unluck 3
#req_temple 1
#msg "In unmagic, unlucky land, the temple was desecrated."
#temple 0
#incdom -6
#unrest 50
#end
...
#req_cold 3
#req_unluck 2
#msg "An unlucky convergence of arctic winds has turned the coastal waters into a graveyard. A specter of the frozen deeps has manifested to lead the drowned against the living."
#incscale2 2
#incscale2 4
#com 181
#4d6units 2119
...
#req_unluck 2
#req_swamp 1
#msg "An unlucky pocket of magma has erupted in the center of the local swamp. The steam is lethal, and the marsh is becoming a wasteland of boiled mud and sulfur."
#decscale 2
#incscale2 4
#kill 25
#unrest 40
...
#req_luck 2
#req_mountain 1
#msg "A lucky encounter on a mountain path has led a giant of the high peaks to offer his services as a guardian of your frozen realm."
#decscale 4
#nation -2
#com 2230
#defence 15
...
#req_unluck 5
#req_cave 1
#msg "The absence of magic has created a spiritual echo. In the absolute, unlucky silence of the caves, the people can hear the sound of their own souls being erased. Mass madness has followed."
#kill 75
#incscale2 5
#researchaff 0
#incdom -10
...
#req_luck 5
#req_land 1
#msg "The high luck of the province has drawn the attention of a celestial smith. He has descended to temper a single weapon of world-shaking power for your greatest commander."
#magicitem 4
#addequip 4
#gold 300
#end
...
#req_magic 3
#req_land 0
#msg "A rift has opened in the center of a chaotic, unlucky merman city. An entity from the void is currently consuming the faith and memories of the inhabitants."
#incdom -15
#com 2213
#kill 20
#researchaff 0
...
#req_magic 1
#req_waste 1
#msg "The isolation of the waste and the lack of a strong temple has allowed a minor 'sun-cult' to form. They claim the shimmer of the heat is the only true god."
#incscale 0
#incscale 4
#incdom -4
#unrest 20
...
#req_magic 2
#req_cave 1
#msg "In the deep caves, the cold and the magic have combined to encase the inhabitants in layers of permanent, glowing ice. The province is a silent museum of frozen lives."
#incscale 2
#decscale 5
#kill 5
#incdom -2
...
#req_death 2
#req_land 1
#msg "The dead have risen in this lawless land, and the people have reacted not with fear, but with greed. They are currently stripping the ancient skeletal warriors of their bronze equipment."
#incscale 0
#incscale 3
#gold 100
#unrest 40
...
#rarity 2
#req_chaos id
#msg "In the deep tunnels, the silence of death has combined with total anarchy. The miners have uncovered an ancient crypt and, instead of sealing it, have begun using the dead as tools for their rebellion."
#name
#end
...
#rarity -1
#req_name
#msg "Death is not feared in this province, but embraced as a natural transition. Loyal shades have risen to maintain the shrines, offering gemid"
#end
...
#req_land 1
#req_turn 20
#msg "Absolute misfortune has drawn a Doom Horror from the void. It has arrived to feed on the absolute despair of the province."
#com 2213
#kill 60
#gold -5000
#temple 0
...
#req_chaos 1
#req_land 1
#msg "In this land of magic and chaos, a rogue apprentice has used the saturated air to trigger a chain reaction in the armory. The resulting 'unlucky' fire was impossible to extinguish."
#gold -400
#defence -10
#unrest 40
#incscale 0
...
#req_cold 2
#req_mountain 1
#msg "Absolute cold and absolute unmagic have turned the mountain province into a place where life cannot exist. The minds of your scholars have frozen solid."
#kill 50
#researchaff 33554432
#incscale 2
#end
